module.exports = {
  products: "select p.producto_nombre as nombre, p.*, uhp.id_unidad, u.nombre_unidad, inventario.id_inventario,\
                    ...
                    f.nombre_familia, g.nombre_grupo, p2.proveedor_nombre, i.nombre_impuesto, uhprecio.id_precio\
            	from producto p\
            left join lineas l\
            ...
            left join unidades_has_precio uhprecio\
  ...
  prices_types: "select *  from precios p where p.estatus_precio = 1",
